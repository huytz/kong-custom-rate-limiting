  ...
  fields = {
    ...
    { config = {
        ...
        fields = {
          ...
          { white_listed_ips = { description = "List of IPs or CIDR ranges to exclude from rate limiting. When the X-Real-IP header (or forwarded IP) matches an IP in this list, rate limiting will not be applied.", type = "array", elements = typedefs.ip_or_cidr }, },
        },
